...
}:
{
  ...
  fluxer-desktop-canary = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-ybe8K6/4aIasZ30+RGTwAyfP4/C+ClmET/aMGBh0tNQ=";
    };
  };
  hytale-launcher = {
  ...
  mesa = {
    pname = "mesa";
    version = "3f1b217baffffa00cb8f53e158713a33e1bd4632";
    src = fetchgit {
      url = "https://gitlab.freedesktop.org/mesa/mesa.git";
      rev = "3f1b217baffffa00cb8f53e158713a33e1bd4632";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-17NiUjgIP+uqOF2qC8kkBywmN3XdBJM1iUlrBRmuqM0=";
    };
    date = "2026-08-23";
  };
  modengine3 = {
